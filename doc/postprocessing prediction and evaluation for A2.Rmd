---
title: "Postprocessing krr A2 and evaluation"
author: "nuanjun zhao"
date: "11/18/2019"
...
q <- read.csv("../output/q_matrix_A2_10dim.csv")
movie<-read.csv("../output/movie_indexes.csv")
rating.a2 <- read.csv("../output/r_100.csv")
```
...
best_lambda <- best_lambda$lambdas
```
...
#get test rmse
dim(test_set)[1]
mean11<-mea(test_set[1:10000,],rating.weighted[[length(rating.weighted)]])
  mean21<-mea(test_set[10001:20000,],rating.weighted[[length(rating.weighted)]])
  mean32<-mea(test_set[20001:dim(test_set)[1],],rating.weighted[[length(rating.weighted)]])
